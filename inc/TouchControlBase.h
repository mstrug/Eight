/*
 ============================================================================
 Name		: TouchControlBase.h
 Author	  : Michal Strug
 Version	 : 1.0
 Copyright   : Copyright (c) 2022 Michal Strug. All rights reserved.
 Description : CTouchControlBase declaration
 ============================================================================
 */

#ifndef TOUCHCONTROLBASE_H
#define TOUCHCONTROLBASE_H
 ...
 * 
 */
class CTouchControlBase : public CBase
    {
public:
...
protected:
    ...
    CTouchControlBase( MTouchButtonObserver* aObserver, TUint aId, TVgRect aRect );
